...
const CartBtns = ({ productId }: { productId: string }) => {
  ...
  return (
    <div className="flex items-center gap-3 w-full pb-5 border-b border-gray-400">
      <button
      ...
      <button className="flex-1 border border-primary primary-btn rounded-none! px-3! h-auto! py-1 text-[15px] relative overflow-hidden group cursor-pointer">
        Add to cart
